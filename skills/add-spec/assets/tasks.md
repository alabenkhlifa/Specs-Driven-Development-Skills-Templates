...
- Slice size: Standard | Exception — <Why every smaller boundary would duplicate an authoritative contract or create an invalid lifecycle or verification state>.
